...
export class GetForm005ByMedicalRecordUseCase {
  ...
  async execute(medicalRecordId: string): Promise<Form005Document[]> {
    return this.form005Repository.getByMedicalRecordId(medicalRecordId);
  }
}
